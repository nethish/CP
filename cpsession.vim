...
inoremap <Plug>TComment_ :TComment
nnoremap  :w | !python3 % < ~/repos/CP/input > ~/repos/CP/output 2>&1 
nnoremap  h
nnoremap 	 
nnoremap <NL> j
nnoremap  k
...
nnoremap  t :w | !cp ~/repos/CP/templates/template.py % 
...
nnoremap <C-B> :w | !python3 % < ~/repos/CP/input > ~/repos/CP/output 2>&1 
