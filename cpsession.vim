...
nnoremap  fb :Buffers
nnoremap  = gg=G``
vnoremap  cc y:%s/"/"/gc<Left><Left><Left>
nnoremap  R :%s//
nnoremap  r *``cgn
map  y "+y
map  P "+P
...
set fillchars=vert:|,fold:-,eob:~,lastline:@,vert:\ 
set helplang=en
set hidden
set hlsearch
set ignorecase
